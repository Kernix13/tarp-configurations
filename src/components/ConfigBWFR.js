...
import BWFRLT25Img from "../assets/images/BWFRLT_25.png";
import BWFRLT33Img from "../assets/images/BWFRLT_33.png";
...
function Config_BWFR() {
  ...
  const BWFRLT_25 = new Config_BWFR("Back Wall Flat-Roof LT 25", userTarp[0], userTarp[1], 0.5, 0.25, BWFRLT25Img);
  BWFRLT_25.calcs();

  const BWFRLT_33 = new Config_BWFR("Back Wall Flat-Roof LT 33", userTarp[0], userTarp[1], 0.333, 0.333, BWFRLT33Img);
  BWFRLT_33.calcs();
